...
/**
 * Created by parth panchal on 25-07-2016.
 */
public class WidgetRemoveViewsService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                fillInIntent.putExtra(StockDetailActivity.INTENT_EXTRA_STOCK_SYMBOL, symbol);
